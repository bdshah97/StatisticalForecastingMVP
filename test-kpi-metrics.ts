// TypeScript test for demand planning KPIs using sample datasets
import assert from 'assert';
import datasets from './test-kpi-sample-datasets.cjs';
import { calculateMAPE, calculateMAPECorrected, calculateMetrics } from './utils/forecasting.ts';

function nearlyEqual(a: number, b: number, tol = 1e-6) {
