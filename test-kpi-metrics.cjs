// Automated test for demand planning KPIs using sample datasets

const assert = require('assert');
const datasets = require('./test-kpi-sample-datasets.cjs');
const { calculateMAPE, calculateMAPECorrected, calculateMetrics } = require('./utils/forecasting.js');
